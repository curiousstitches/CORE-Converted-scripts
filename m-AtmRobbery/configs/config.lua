...
Config.Settings = {
	...
	PSui = { NumberOfCircles = 5, MS = 20 }, -- PS-UI Minigame Settings
	Rewards = {
		Type = "blackmoney", -- "cash" or "blackmoney"
		Cash = {
			min = 3500, -- Min amount receive in cash
			max = 7500, -- Max amount receive in cash
		},
		Blackmoney = {
			Bags = 3, -- Amout of bags receive
			Item = "markedbills", -- Item name of blackmoney
			Worth = {
				min = 1500, -- Min amount receive each bag
